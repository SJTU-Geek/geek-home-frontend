...
const paragraphs = [
  '上海交通大学学生信息技术协会，英文全称 SJTU Student Information Technology Association，别名思源极客协会，简称思源极协，英文别名 Si-Yuan Geek Association，是在上海交通大学学生工作指导委员会领导下，由学生事务中心、网络信息中心、共青团上海交通大学委员会共同指导的校级学生组织。协会汇集校内信息技术人才，是学校培养、组织学生自主参与校园信息化建设的平台与纽带。',
  ...
  '协会始终坚持以"来自学生、立足学生、服务学生、引领学生"为发展定位，引领学生在科技创造中贡献交大智慧、在服务实践中践行科技向善理念，不断传承交大精神，共创美好未来，持续打造符合每一代上海交通大学学子切实需要的数字化、智慧化美好校园生态。',
];
